...
RPC_ENDPOINTS='{
  ...
  "arbt": ["https://arbitrum-sepolia.drpc.org", "https://arb-sepolia.g.alchemy.com/v2/6jeB5A-_L7hrXI0O9mNnPjEcZ9MjlFvX"],
  "bast": ["https://base-sepolia-rpc.publicnode.com", "https://base-sepolia.g.alchemy.com/v2/6jeB5A-_L7hrXI0O9mNnPjEcZ9MjlFvX"],
  "opst": ["https://sepolia.optimism.io", "https://opt-sepolia.g.alchemy.com/v2/S5lMuaYuP8YUS4o0OfQKnaX9xAw64x6Y"],
  "mont": ["https://testnet-rpc.monad.xyz", "https://monad-testnet.g.alchemy.com/v2/AfcgJHyFOf1hvlNlhtOA7beCJsaDs0S9"],
  "unit": ["https://unichain-sepolia.drpc.org", "https://unichain-sepolia.g.alchemy.com/v2/6jeB5A-_L7hrXI0O9mNnPjEcZ9MjlFvX"]
}'
...
Environment=EXECUTOR_MIN_TX_ETH=0.1
